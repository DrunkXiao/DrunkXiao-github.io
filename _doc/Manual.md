...
```yml
# Site settings
title: drunkxiao Blog             # title of your website
SEOTitle: drunkxiao Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: drunkxiao     # modify this account to yours
weibo_username: drunkxiao      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-drunkxiao.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“drunkxiao Blog”** but I want the title shows in search engine is **“黄玄的博客 | drunkxiao Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/drunkxiao/drunkxiao.github.io/issues/15) about code wrap.
